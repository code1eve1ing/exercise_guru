...
const Schedule = () => {
  ...
  return (
    <div className='pb-20 flex justify-center flex-col'>
      {schedules.length > 0 &&
        <>
      ...
      <div
        className={`cursor-pointer translate-x-[-50%]  rounded-t-full sm:rounded-full absolute bottom-0 left-[50%] w-28 h-28 bg-red-500 z-40 flex items-center justify-center`}>
        <span className='translate-y-[-50%] sm:translate-y-0'>S T A R T</span>
      </div>
    </div>
  )
}
